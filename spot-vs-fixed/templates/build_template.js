...
pres.author = "Commercial analysis";
pres.title = "Spot or fixed: matching the product to the load";
...
function footer(slide, page) {
  slide.addText("Source: energy-charts.info (Fraunhofer ISE), CC BY 4.0  |  Czech day-ahead market  |  {{PERIOD}}", {
...
// -------------------------------------------------------------- 3-6. charts
chartSlide("intraday", 3);
chartSlide("factors", 4);
chartSlide("spread", 5);
chartSlide("negative", 6);
