...
def main() -> None:
    ...
    values = {
        ...
        "S5_LEDE": "Modelled: a PVGIS generation shape weighted against each year's "
                   "actual day-ahead prices, compared with the flat baseload price "
                   "of the same year.",
        "S5_TAKEAWAY":
            f"On this basis solar earned "
            f"{capture[str(capture_years[0])]['capture_rate']:.2f} of the "
