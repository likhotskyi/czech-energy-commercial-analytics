...
# --------------------------------------------------------------------- PVGIS
# A rooftop array is not a free-standing one: panels lying close to a roof run
# hotter and lose a few percent in summer. `mountingplace=building` tells PVGIS to
# model that, and it is the difference between a plausible number and a flattering
# one. 35 degrees facing due south is the usual optimum for this latitude.
PV_DEFAULTS = {
