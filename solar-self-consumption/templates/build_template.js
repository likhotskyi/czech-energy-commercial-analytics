...
pres.title = "Rooftop solar: which customers, and how big";
...
function footer(slide, page) {
  slide.addText("Sources: PVGIS (EC JRC), energy-charts.info (Fraunhofer ISE), Eurostat  |  {{PERIOD}}", {
...
chartSlide("day", 3);
chartSlide("sizing", 4);
chartSlide("capture", 5);
chartSlide("locations", 6);
