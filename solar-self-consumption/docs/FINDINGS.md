...
The price solar earns on the Czech wholesale market, against the flat baseload price
of the same year:
...
*EUR/MWh. Capture price = the PV-output-weighted average price.*

Solar earned 89% of the baseload price in 2021 and 62% in 2025. The mechanism is
