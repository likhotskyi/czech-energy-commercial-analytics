...
That one line decides everything downstream. A supplier's whole "what share of the bill is ours" calculation
is wrong if you skip it — and the wrong number looks perfectly plausible, which is why
it would survive a review.
