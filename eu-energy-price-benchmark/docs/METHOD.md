...
Everything here is a judgement call that could have gone another way. Each one is
written down with its reason, because a number you cannot explain is a number you
cannot defend in a meeting.
